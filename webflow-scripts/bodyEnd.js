/*! For license information please see bodyEnd.e8a1f3339203d44c6d23.js.LICENSE.txt */
( () => {
    "use strict";
    var e = {
        6489: (e, n) => {
            ...
            n.serialize = function(e, n, i) {
                ...
                if (l.httpOnly && (d += "; HttpOnly"),
                l.secure && (d += "; Secure"),
                l.priority)
                    switch ("string" == typeof l.priority ? l.priority.toLowerCase() : l.priority) {
                    case "low":
                        d += "; Priority=Low";
                        break;
                    case "medium":
        ...
        8596: (e, n, a) => {
            ...
            n.initLanguageSelect = n.hideLocalizer = n.updateSelectedLanguage = void 0;
            const o = a(3257)
              , i = a(2717)
              , t = a(2717);
            function l(e) {
            ...
            function c() {
                const e = (0,
                t.getLocalizerLanguage)();
                if (null == e)
                    return;
                let n = document.querySelector(".lang-selector-container .flag");
                n && (n.classList.remove(...n.classList),
                n.classList.add("flag", "flag-" + e.code));
                let a = document.querySelector(".lang-selector-container .selector-language-name");
            ...
            n.initLanguageSelect = function() {
                ...
                function(e) {
                    if (e) {
                        let n = document.querySelector(".language .lang-dropdown-container .lang-dropdown");
                ...
                function() {
                    let e = document.querySelectorAll(".language .lang-container .dropdown-item");
                    e && e.forEach((function(e) {
                        e.addEventListener("click", (function(n) {
                            ...
                            if (a) {
                                ...
                                (0,
                                i.setBrowserCookieLanguage)(e),
                                window.__skippedLocalizeInit && (0,
                                o.initLocalizeJS)(),
                                (0,
                                t.setBrowserLanguage)(e),
                                r(),
                                (0,
                                i.getAvailableLanguages)(),
                                c()
                        ...
                        e.addEventListener("keyup", (function(n) {
                            n.preventDefault(),
                            "Enter" === n.code && e instanceof HTMLElement && e.click()
                        }
                        ))
                    }
                    )),
                    document.addEventListener("keyup", (function(e) {
                        if ("Escape" === e.code) {
                            ...
                            e && "block" === window.getComputedStyle(e, null).display && r()
                        }
                    }
                    ))
                }(),
                function() {
                    let e = document.querySelectorAll(".language .lang-container .lang-selector-container");
                    e && e.forEach((function(e) {
        ...
        3257: (e, n, a) => {
            ...
            n.initLocalizeJS = function() {
                ...
                window.Localize.setLanguage(n)) : (window.__skippedLocalizeInit = !0,
        ...
        2717: function(e, n, a) {
            ...
            n.getAvailableLanguages = n.setBrowserLanguage = n.setInitialBrowserLanguage = n.isStaging = n.setBrowserCookieLanguage = n.getLocalizerLanguage = n.getBrowserLanguage = void 0;
            const i = o(a(6489))
              , t = o(a(4080))
              , l = o(a(2866))
              , c = {}
            ...
            function g() {
                let e = [];
                return window.Localize.getAvailableLanguages((function(n, a) {
                    n ? console.error(n) : e = a.sort((function(e, n) {
            ...
            t.default.forEach((e => {
                "string" == typeof e.localizeCode && "string" == typeof e.code && (c[e.localizeCode] = e.code,
                r[e.code] = e.localizeCode)
            }
            )),
            ...
            n.getLocalizerLanguage = function(e) {
                ...
                let o, i = e && null != r[e] ? r[e] : window.Localize.getLanguage();
                if (null == i && (i = d.code),
                null != a[i])
                    return a[i];
            ...
            n.setInitialBrowserLanguage = function(e) {
                u() && window.Localize.setLanguage(e),
                s(e)
            }
            ,
        ...
        638: (e, n) => {
            ...
            n.setupDownloads = n.handleExternalDownloadClick = n.downloadFile = void 0,
            ...
            n.setupDownloads = () => {
                document.querySelectorAll("[data-download-file]").forEach((e => {
                    const a = e;
                    a.addEventListener("click", (0,
                    n.handleExternalDownloadClick)(a.dataset.downloadFile ?? "untitled"))
                }
                ))
            }
        }
    ...
    function a(o) {
        ...
        return e[o].call(t.exports, t, t.exports, a),
        t.exports
    }
    ( () => {
        const e = a(638)
          ...
          , o = () => {
            ...
            window.Localize.off("setLanguage", o)
        }
        ;
        "source" === window.Localize.getLanguage() ? window.Localize.on("setLanguage", o) : (0,
        n.initLanguageSelect)(),
        (0,
        e.setupDownloads)()
    }
